<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="NhotCF.Admin.Product" %>
                                                 ...
                                                 <div class ="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                                            ErrorMessage="Descrpition is required" ForeColor="Red" Display="Dynamic"
                                                 ...
                                                 <div class ="form-group">
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtPrice" runat="server" CssClass="form-control"
                                                            placeholder="Enter Product Price" TextMode="MultiLine"></asp:TextBox>
                                                ...
                                                <div class ="form-group">
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtQuantity" runat="server" CssClass="form-control"
                                                            placeholder="Enter Product Quantity" TextMode="MultiLine"></asp:TextBox>
                                                    ...
                                                    <asp:Repeater ID="rProduct" runat="server" OnItemCommand ="rProduct_ItemCommand"
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>  
                                                                    <img alt="" height="40" src="<%# Utils.GetImageUrl( Eval("ImageUrl")) %>" />
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="LnkEdit" Text="Edit" runat="server" 
                                                                     ...
                                                                     <asp:LinkButton ID="LnkDelete" Text="Delete" runat="server" 
                                                                         CssClass="badge bg-danger" CausesValidation="false"
