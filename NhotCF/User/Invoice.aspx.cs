...
namespace NhotCF.User
{
    public partial class Invoice : System.Web.UI.Page
    {
        ...
        DataTable GetOrderDetails()
        {
            ...
            cmd = new SqlCommand("Bill", con);
            cmd.Parameters.AddWithValue("@Action", "BILLBYID");
        ...
        protected void lbDownloadBill_Click(object sender, EventArgs e)
        {
            try
            {
                string downloadPath = @"D:\order_bill.pdf";
                DataTable dtbl = GetOrderDetails();
                ExportToPdf(dtbl, downloadPath, "Order Bill" );
        ...
        void ExportToPdf(DataTable dtblTable, String strPdfPath, string strHeader)
        {
            ...
            prgAuthor.Add(new Chunk("Order From : Nhót Coffee", fntAuthor));
