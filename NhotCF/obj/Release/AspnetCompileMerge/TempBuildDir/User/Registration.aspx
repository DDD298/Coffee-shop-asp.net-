<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="NhotCF.User.Registration" %>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>                           
                            <asp:RequiredFieldValidator ID="rfvID" runat="server" ErrorMessage="ID is required" ControlToValidate="txtID"
                                ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="revID" runat="server" ErrorMessage="ID must have 12 digits"
                                ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ValidationExpression="^[0-9]{12}$"
                                ControlToValidate="txtID"></asp:RegularExpressionValidator>
                            <asp:TextBox ID="txtID" runat="server" CssClass="form-control" placeholder="Enter ID"
                                ToolTip="ID" TextMode="Number"></asp:TextBox>
                        </div>
                ...
                <div class="row pl-4">
                    <div class="btn-box">
                        ...
                        <asp:Label ID="lblAlreadyUser" runat="server" CssClass="pl-3 text-white-100" 
