<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="NhotCF.User.Cart" %>
    ...
    <section class="book_section layout_padding">
        <div class="container">
            <div class="heading_container">
                ...
                <h2 style="color: #ffffff">Your Shopping Cart
                </h2>
            </div>
        </div>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:LinkButton ID="lbDelete" runat="server" Text="Remove" CommandName="remove" 
                                  ...
                                  OnClientClick="return confirm('do you want to remove this item form cart?');"> 
