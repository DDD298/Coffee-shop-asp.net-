<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="NhotCF.User.Payment" %>
        ...
        <div class="container py-5">
            ...
            <div class="row mb-4">
                <div class="col-lg-8 mx-auto text-center">
                    <h1 class="display-6" style="color:white">Orders Payment</h1>
                </div>
            </div>
            <!-- End -->
            <div class="row">
                            ...
                            <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                                ...
                                <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                                    ...
                                    <li class="nav-item"><a data-toggle="pill" href="#paypal" class="nav-link "><i class="fa fa-money mr-2"></i>Cash on Delivery</a></li>
                                     <li class="nav-item"><a data-toggle="pill" href="#qr-code" class="nav-link "><i class="fa fa-qrcode mr-2"></i>QR Code</a></li>
                                </ul>
                                <!-- End -->
                            </div>
                            ...
                            <div class="tab-content">
                                    ...
                                    <div role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                ErrorMessage="Card Number must be 16 digits" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                            ...
                                            <div class="col-sm-8">
                                                <div class="form-group">
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server"
                                                        ErrorMessage="Expiry month must be 2 digits" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server"
                                                        ErrorMessage="Expiry Year must be 4 digits" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server"
                                                        ErrorMessage="Cvv Number must be 3 digits" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                                        ValidationExpression="[0-9]{3}" ControlToValidate="txtCvv" ValidationGroup="card">*
                                                    </asp:RegularExpressionValidator>
                                                    <asp:TextBox ID="txtCvv" runat="server" CssClass="form-control" placeholder="Cvv number"
                                                        TextMode="Number"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            <asp:LinkButton ID="lbCardSumbit" runat="server" CssClass="subscribe btn btn-info btn-block shadow"
                                                ValidationGroup="card" OnClick="lbCardSumbit_Click">Confirm Payment</asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                                <!-- End -->     
                                ...
                                <div id = "qr-code" class="tab-pane fade pt-3">
                                    <div class = "form-group">
                                       ...
                                       <div>
                                           <img src="../Images/QRPAY.png"  style="margin-left: 90px;"/>
                                       </div>
                                    </div>
                                     <p>
                                        <asp:LinkButton ID="lbSumbit" runat="server" CssClass="btn btn-info" ValidationGroup="cod" 
                                            OnClick="lbCodSumbit_Click">
                                   <i class="fa fa-cart-arrow-down mr-2"></i>Confirm Payment</asp:LinkButton>
                                    </p>
                                    <p class="text-muted">
                                        Lưu ý: Sau khi hoàn tất quá trình thanh toán, bạn có thể kiểm tra trạng thái đơn hàng đã cập nhật của mình.
                                    </p>
                                </div>
                                <!--End -->
                                ...
                                <div id="paypal" class="tab-pane fade pt-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtID" runat="server" CssClass="form-control" placeholder="Địa chỉ: "></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvID" runat="server" ErrorMessage="ID is required"
                                            ControlToValidate="txtID" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                            ValidationGroup="cod" Font-Names="Segoe Script"></asp:RequiredFieldValidator>
                                    </div>
                                    <p>
                                        <asp:LinkButton ID="lbCodSumbit" runat="server" CssClass="btn btn-info" ValidationGroup="cod" 
                                            OnClick="lbCodSumbit_Click">
